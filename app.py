...
# Load model and processor explicitly on the appropriate device
model = id2ft._load_model(model_id=model_id) if device.type == "cuda" else AutoModelForVision2Seq.from_pretrained(model_id).to(device)
